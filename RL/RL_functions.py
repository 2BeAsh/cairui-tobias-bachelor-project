...
reg_offset = 0.05
coord_plane = "yz"
train_total_steps_direction = int(12e5)

# Variables
target_radius_variable = 0.5
target_initial_position_variable = [2.4, 2.4] / np.sqrt(2)
...
#direction.mode_iteration_average_plot(max_mode_direction, N_model_runs=10, PPO_list=[1, 2, 3, 4, 5, 6, 7], changed_parameter="position", plot_reward=True, subfolder="center_distance")
